...
def run_experiment():
    protocol_name = "PMAP_ACK"
    experiment_name = "单轮攻击"
    d2z_ack_mode = True
    ...
    attack_model = {
        ...
        "desync_attack_min_completed_sessions": ATTACK_ROUND - 1,
        "desync_attack_max_completed_sessions": ATTACK_ROUND
    }
